let strings = {
  ...
  esteDadoNaoPodeSerEditado: "This data can't be edited!",

  // Editar
  salvar: "Save",

  // Fale conosco
  porFavorExpliqueDetalhadamenteOSeuProblemaOuDuvida:
    "Please explain in detail your problem or question.",
  enviar: "Send",
  ...
  verifiqueASuaConexaoComAInternetETenteNovamente:
    "Check your internet connection and try again",

  // Login
  toqueSuasMusicasFavoritasComAcompanhamento:
    "Play your favorite songs with accompaniment!",
  facaLoginParaAproveitarOMaximoDoAplicativo:
    "Sign in to get the most out of your app"
};
